...
<div class="wrap">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?php echo U('scripture/edit');?>">编辑笔记</a></li>
    </ul>
    <form method="post" class="form-horizontal js-ajax-form layui-form" action="<?php echo U('scripture/edit_post');?>">
        <fieldset>

            <div class="control-group">
                <label class="control-label">笔记标题</label>
                <div class="controls">
                    <input type="text" autocomplete="off" value="<?php echo ($data["title"]); ?>"  placeholder="输入笔记标题" name="title">
            ...
            <div class="control-group">
                ...
                <div class="controls clearfix" style="min-width: 800px;width:60%">
                    <script type="text/plain" id="content" name="content" ><?php echo html_entity_decode($data['content']);?></script>
                </div>
            </div>
        </fieldset>
        <div class="form-actions">
            <button type="submit" class="btn btn-success js-ajax-submit" id="btnSubmit"><?php echo L('SAVE');?></button>
        </div>
    </form>
</div>
