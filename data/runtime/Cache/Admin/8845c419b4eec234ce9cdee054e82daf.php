		...
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('User/add_post');?>">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" autocomplete="off" name="user_name" placeholder="请输入用户姓名" maxlength="25">
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">手机号</label>
					<div class="controls">
						<input type="text" autocomplete="off" maxlength="11" name="mobile" placeholder="请输入正确格式的手机号">
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">用户<?php echo L('ROLE');?></label>
					<div class="controls">
