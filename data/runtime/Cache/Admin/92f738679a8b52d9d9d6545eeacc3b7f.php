...
.nav-list li._active >a >span,.nav-list li._active>a> i{
	color: #0b6cbc;
}
</style><?php endif; ?>
...
<body style="min-width:900px;" screen_capture_injected="true">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<div class="pull-left nav_shortcuts" >
					...
					<!--<?php if(sp_auth_check(sp_get_current_admin_id(),'portal/AdminPost/index')): ?>-->
					<!--<a class="btn btn-small btn-info" href="javascript:openapp('<?php echo U('portal/AdminPost/index');?>','index_postlist','<?php echo L('PORTAL_ADMINPOST_INDEX');?>');" title="<?php echo L('PORTAL_ADMINPOST_INDEX');?>">-->
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						...
						<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
							<!--<?php if(sp_auth_check(sp_get_current_admin_id(),'admin/setting/site')): ?>-->
								<!--<li><a href="javascript:openapp('<?php echo U('setting/site');?>','index_site','<?php echo L('ADMIN_SETTING_SITE');?>');"><i class="fa fa-cog"></i> <?php echo L('ADMIN_SETTING_SITE');?></a></li>-->
							<!--<?php endif; ?>-->
    ...
    $("#nav_wraper .nav-list li").on("click", function () {
        if(!$(this).hasClass("_active")){
            $(".open .submenu").slideUp(150);
            $(".nav-list li").removeClass("_active").removeClass("open");
