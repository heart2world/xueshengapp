        ...
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls clearfix" id="intro_box">
                    <!--  <?php if(is_array($intro_arr)): foreach($intro_arr as $key=>$img): ?><div class="span3" style="width: 150px;margin-bottom: 10px;">
                              <img src="<?php echo sp_get_image_preview_url($img['img']);?>" onerror="this.src='/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png'" />
                              <input type="hidden" name="img[<?php echo ($key); ?>]" class="intro_info" id="info_<?php echo ($key); ?>" value="<?php echo ($img['img']); ?>">
                              <input type="text" style="width: 135px;margin-top: 5px" name="sort[<?php echo ($key); ?>]" placeholder="排序" value="<?php echo ($img["sort"]); ?>">
